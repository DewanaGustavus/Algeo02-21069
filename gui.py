...
image_image_1 = ImageTk.PhotoImage(Image.open("testname.png"))
...
img = ImageTk.PhotoImage((Image.open("blank3.png")).resize((256, 256), Image.Resampling.LANCZOS))
...
img2 = ImageTk.PhotoImage((Image.open("blank3.png")).resize((256, 256), Image.Resampling.LANCZOS))
